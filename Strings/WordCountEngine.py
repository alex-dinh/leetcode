...
say the code first, then write
write some tests, debug

optimal: bucketsort and ordered_dict, O(n)
'''

'''
Feedback
- try to speak our your entire code process before doing any coding
    - maybe write pseudocode?
- lot of coding errors:
    - strings are immutable
    - had to return string, not ints for word count
    - outOfBounds error during looping through string
- practice more

Optimal Solution: O(n)
- uses bucketsort and ordered_dict
'''